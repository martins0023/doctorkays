...
import { mos, whatismos, east, healthnugget, stayintouch, blogsection, moscard1, north_east, moscard2, clinicseries, clinicseries1, clinicseries2, clinicsection } from "../assets";
  ...
  const healthNuggetCards = [
    {
      ...
      content: "Morbi mattis nisi id orci finibus egestas Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
      date: "11 Dec 2024",
      ...
      <main className="flex-grow">
        ...
        <Section title="Health Nuggets">
          ...
          <p className="font-montserrat text-[14px] text-center font-medium">
            Donec dui massa, varius a consequat at, ultrices a neque. Ut augue erat,
            dignissim ultricies bibendum sed, pharetra ut neque. Aliquam venenatis
            felis odio, eget molestie velit tristique nec. Praesent ac erat sit amet
            risus maximus fermentum in a urna.
          </p>
          ...
          <div className="flex flex-col gap-4 mt-4">
            {healthNuggetCards.map((card, index) => (
              <div
                key={index}
                className=" bg-white rounded-t-lg w-full gap-3"
              >
                <div className="w-full">
                  ...
                  <div className="bg-primary p-2">
                    ...
                    <p className="text-[14px] font-poppins font-normal text-white mb-4">{card.content}</p>
                    <div className="flex items-center justify-between">
                      <span className="text-white text-[12px]">{card.date}</span>
                      <span className="text-white text-[12px]">{card.readTime}</span>
                    </div>
        ...
        <Section title="Blog / News">
          ...
          <p className="font-montserrat text-[14px] text-center font-medium">
            Donec dui massa, varius a consequat at, ultrices a neque. Ut augue erat, dignissim ultricies bibendum sed, pharetra ut neque.
          </p>
        </Section>
