  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mt-10 p-4">
        ...
        <img src={aivoicestatic} alt="AI Avatar" className="w-[140px] h-[140px] rounded-full mt-5" />
        <p className="mt-5 text-center text-gray-600 font-montserrat font-medium text-[16px]">
          <Typical
            steps={['Hola', 2000, 'Hello', 2000, 'Bonjour', 2000, 'Hallo', 2000, 'Ẹ n lẹ', 2000]}
            loop={Infinity}
            wrapper="span"
        ...
        <p className="mt-5 text-center text-gray-600 text-sm">
          Please contact your <span className="text-primary">doctor</span> before taking any recommended medications.
        </p>
      </div>
    </motion.div>
  );
